...
<label class="inv-field inv-field-name"><span>Item</span><input type="text" class="inv-name" data-mi-name="${i}" placeholder="Nome do item" value="${escapeHtml(it.name)}"></label>
<label class="inv-field inv-field-weight"><span>Peso</span><input type="number" class="inv-weight" data-mi-weight="${i}" placeholder="Peso" min="0" step="0.5" value="${it.weight}"></label>
<label class="inv-field inv-field-qty"><span>Qtd.</span><input type="number" class="inv-qty" data-mi-qty="${i}" placeholder="Qtd" min="0" step="1" value="${it.qty}"></label>
...
<span>Subtotal <b>${Math.round((parseFloat(it.weight) || 0) * (parseInt(it.qty, 10) || 0) * 100) / 100}</b></span>
</div>
</div>`).join('')}
