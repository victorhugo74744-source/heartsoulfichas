...
window.HEARTSOUL_RACES = [
 ...
 },
 {
  ...
  "fixedTrait": "Sopro Dracônico (Metálico): Você pode exalar uma descarga elemental de sua boca, como os dragões de sua linhagem. Ação Principal. Dano: 1d6 + Constituição. Tipo de dano: Ouro (Fogo), Prata (Gélido), Bronze (Elétrico), Cobre (Ácido), Latão (Fogo em cone amplo). Alcance: cone de 3 metros ou linha de 6 metros (varia pela linhagem). Uma vez por combate. Em nível 10: 2d6. Suas costas abrigam um par de asas metálicas plenamente desenvolvidas, capazes de erguer seu corpo em voo: deslocamento de voo de 9 metros, por até 10 minutos contínuos (após esse período, precisa descansar por 1 hora, descanso curto, para voar novamente). Enquanto voa, você não pode usar armas de duas mãos ou arcos longos. Suas asas são resistentes: usadas como escudo, concedem +1 Defesa enquanto estiver no chão e consciente.",
  "optionalTraits": [
 ...
 },
 {
  ...
  "fixedTrait": "Sopro Dracônico (Cromático): Você pode exalar uma descarga elemental de sua boca, como os dragões de sua linhagem. Ação Principal. Dano: 1d6 + Constituição. Tipo de dano: Vermelho (Fogo), Azul (Elétrico), Verde (Ácido/Veneno), Preto (Ácido corrosivo), Branco (Gélido). Alcance: cone de 3 metros ou linha de 6 metros (varia pela linhagem). Uma vez por combate. Em nível 10: 2d6. De suas costas brotam asas membranosas, escuras como a noite, que lhe permitem voar como um predador: deslocamento de voo de 9 metros, por até 10 minutos contínuos (após esse período, precisa descansar por 1 hora, descanso curto, para voar novamente). Enquanto voa, você não pode usar armas de duas mãos ou arcos longos. Suas asas permitem planar silenciosamente: +2 em testes de Furtividade durante o voo.",
  "optionalTraits": [
