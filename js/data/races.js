...
window.HEARTSOUL_RACES = [
 ...
 },
 {
  ...
  "optionalTraits": [
   ...
   "Memória Ancestral: Você herdou as lembranças de seus antepassados élficos, e eles sussurram sabedoria em sua mente. +1 Intelecto. Uma vez por cena, ao realizar um teste de Intelecto, Foco ou Vontade, você pode rolar o dado novamente e ficar com o melhor resultado.",
   "Melodia Élfica: A música élfica acalma, encanta e manipula emoções. +2 em testes de Atuação ou Música. Uma vez por descanso curto, você pode tocar uma melodia que acalma aliados: remove efeitos de medo de até 2 aliados a 6 metros."
  ]
 },
 {
  "id": "raca-elfo-negro",
  ...
  "optionalTraits": [
   ...
   "Tradição Venenosa: Sua linhagem carrega o conhecimento ancestral das artes venenosas, passado de geração em geração nas profundezas. +2 em testes para aplicar veneno em armas ou identificar substâncias tóxicas. Uma vez por combate, ao acertar um ataque com uma arma, você pode aplicar um veneno imediatamente: o alvo sofre 1d4 de dano adicional e -1 em testes físicos por 1 turno.",
   "Conexão Subterrânea: Você cresceu nos túneis escuros e conhece os segredos que a superfície desconhece. +2 em testes de Sobrevivência e Orientação em ambientes subterrâneos ou cavernas. Você pode se comunicar de forma básica com aranhas, morcegos e outras criaturas das cavernas, pedindo pequenos favores (como verificar uma passagem ou alertar sobre perigo)."
  ]
 },
 {
  "id": "raca-meio-elfo",
 ...
 },
 {
  ...
  "optionalTraits": [
   ...
   "Regeneração Vampírica: Seu corpo se cura sozinho na escuridão. Enquanto estiver em escuridão ou penumbra, você recupera 1 PV no início de cada turno (máximo de 5 PV por cena).",
   "Nobreza Noturna: Você é respeitado — ou temido — pelas criaturas da noite. +2 em testes de Persuasão e Intimidação com mortos-vivos, vampiros, lobisomens e outras criaturas noturnas."
  ]
 },
 {
  "id": "raca-dampiro",
  ...
  "optionalTraits": [
   ...
   "Sedução Sobrenatural: Sua herança vampírica lhe concede um charme hipnótico. +2 em testes de Persuasão e Enganação. Uma vez por cena, ao seduzir ou manipular alguém, pode forçá-lo a um teste de Vontade (CD 18) ou ele fica fascinado por 2 turnos.",
 ...
 },
 {
  ...
  "optionalTraits": [
   ...
   "Toque Necrótico: Suas mãos drenam o calor vital dos vivos. Seus ataques desarmados causam 1d4 de dano necrótico adicional. Ao causar dano desarmado, você pode gastar uma Reação para recuperar 1 PV (uma vez por combate).",
   "Presença Aterrorizante: Sua aparência lembra aos vivos o destino que os espera. +2 em testes de Intimidação. Inimigos vivos com Sanidade abaixo da metade sofrem -1 em testes de ataque contra você.",
