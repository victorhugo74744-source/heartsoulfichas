...
"Ambição Incansável: Você tem um desejo ardente de alcançar seus objetivos, não importa o quão difíceis sejam. +1 Vontade. Uma vez por sessão, ao falhar em um teste relacionado ao seu objetivo principal, você pode rolar novamente e ficar com o segundo resultado.",
"Resiliência Humana: Os humanos são subestimados, mas você é a prova de que a raça é mais resistente do que aparenta. +1 em todos os testes de resistência. Uma vez por dia, ao sofrer dano que o mataria, você pode permanecer com 1 PV em todas as partes do corpo (não morre imediatamente)."
]
},
{
"id": "raca-elfo",
...
"fixedTrait": "Herança Élfica: Sangue élfico corre diluído em suas veias — não o bastante para dispensar o sono por completo, como um elfo puro, mas o suficiente para tornar seu descanso mais eficiente. Além disso, você carrega a herança social de ambas as raças progenitoras, o que o torna um mediador natural entre elas. +1 Foco. Seu descanso longo dura apenas 5 horas (em vez das 8 usuais) para conceder os mesmos benefícios de recuperação completa. +2 em testes de Persuasão e Diplomacia ao interagir com elfos ou humanos. Vantagem narrativa ao atuar como mediador em conflitos interculturais.",
"optionalTraits": [
...
"fixedTrait": "Resiliência Orc: O corpo de um orc é preparado para a guerra desde o nascimento. Mesmo quando ferido gravemente, você continua lutando quando outros já teriam caído. +2 Constituição. Uma vez por combate, ao zerar o HP de uma parte do corpo, teste de Constituição (CD 12): se passar, a parte permanece funcional com 1 HP.",
"optionalTraits": [
...
"Guardião do Clã: Você foi treinado para proteger os membros mais fracos do seu clã. +1 Defesa. Quando um aliado adjacente sofrer um ataque, você pode gastar sua Reação para se colocar na frente e receber o dano no lugar dele."
]
},
{
"id": "raca-meio-orc",
...
"Força Desproporcional: Mesmo para seu tamanho, você é anormalmente forte. Seus músculos parecem subestimar a gravidade. +2 Força. Capacidade de carga como se tivesse +2 adicionais de Constituição.",
...
"fixedTrait": "Constituição das Montanhas: Forjados na dureza das rochas, os anões são excepcionalmente resistentes, seus olhos se acostumaram à escuridão das cavernas onde vivem, e suas mãos são tão resistentes que trabalham metal quente sem luvas. +2 Constituição, +1 Força. +2 adicional em testes para resistir a venenos ou doenças. Visão no escuro total até 12 metros (em preto e branco); em penumbra, visão colorida e nítida. Você não sofre dano ao tocar objetos quentes (como metal recém-forjado). +1 em testes de Ferraria ou Metalurgia.",
"optionalTraits": [
...
"Fígado de Ferro: Seu fígado é lendário, capaz de processar qualquer substância tóxica sem efeito. +1 Constituição. Vantagem em testes de resistência contra venenos e efeitos de embriaguez. Você pode beber qualquer quantidade de álcool sem sofrer penalidades (narrativamente, você nunca fica bêbado a menos que queira).",
"Força de Três Anões: Sua força é desproporcional ao seu tamanho, como se três anões vivessem em seu corpo. +1 Força. Sua capacidade de carga é calculada como se você tivesse +2 de Constituição adicional. Você pode carregar um aliado caído sem sofrer penalidades de movimento."
]
},
{
"id": "raca-meio-an-o",
...
"fixedTrait": "Linhagem Dividida: Você carrega a herança de dois povos que raramente se entendem, e isso o torna mais forte. Seus olhos também herdaram parte da adaptação anã à escuridão das montanhas. +2 em testes de Persuasão ao interagir com anões ou humanos. Uma vez por cena, pode repetir um teste de resistência recém-falhado, ficando com o novo resultado. Visão em penumbra até 9 metros; em ambientes totalmente escuros, discerne formas vagas a até 3 metros.",
"optionalTraits": [
...
"Orgulho Dividido: Você não é totalmente anão nem totalmente humano, e isso o torna teimosamente independente. +1 Vontade. +2 em testes de resistência contra intimidação e manipulação. Quando alguém tenta convencê-lo a agir contra sua vontade, você tem vantagem no teste de resistência.",
"Resistência de Ferro: Você herdou a lendária resistência anã a toxinas, mas seu sangue humano a tornou ainda mais adaptável. +1 Constituição. Vantagem em testes de resistência contra venenos, doenças e efeitos de intoxicação. Você pode beber álcool sem sofrer penalidades por embriaguez (a menos que beba quantidades absurdas)."
]
},
{
...
"fixedTrait": "Sangue do Dragão Metálico: O sangue dos dragões nobres corre em suas veias, concedendo a você o sopro elemental de sua linhagem e asas metálicas plenamente desenvolvidas. Sopro Dracônico (Metálico): Você pode exalar uma descarga elemental de sua boca, como os dragões de sua linhagem. Ação Principal. Dano: 1d6 + Constituição. Tipo de dano: Ouro (Fogo), Prata (Gélido), Bronze (Elétrico), Cobre (Ácido), Latão (Fogo em cone amplo). Alcance: cone de 3 metros ou linha de 6 metros (varia pela linhagem). 3 de estamina por uso. Em nível 10: 2d6. Asas Metálicas: Suas costas abrigam um par de asas metálicas capazes de erguer seu corpo em voo. Deslocamento de voo de 9 metros. Enquanto voa, você não pode usar armas de duas mãos ou arcos longos. Suas asas são resistentes: usadas como escudo, concedem +2 Defesa enquanto estiver no chão e consciente.",
"optionalTraits": [
...
"Sabedoria Ancestral: Você herdou a memória e a sabedoria de seus ancestrais dracônicos. +2 Intelecto. Uma vez por cena, ao realizar um teste de Intelecto ou Foco, você pode rolar novamente e ficar com o melhor resultado.",
"Sopro Aprimorado: Seu sopro dracônico é mais forte e seu corpo também. O dano do seu Sopro Dracônico aumenta em +1d4. +2 Constituição.",
...
"Égide do Dragão: Você pode invocar uma barreira de escamas metálicas ao seu redor, protegendo-se de ataques. +1 Defesa. Uma vez por combate, ao sofrer dano, você pode reduzir o dano em 2d4 (Reação)."
]
},
{
...
"fixedTrait": "Sangue Cromático: O sangue dos dragões cromáticos corre em suas veias, concedendo a você o sopro elemental de sua linhagem e asas membranosas de predador. Sopro Dracônico (Cromático): Você pode exalar uma descarga elemental de sua boca, como os dragões de sua linhagem. Ação Principal. Dano: 1d6 + Constituição. Tipo de dano: Vermelho (Fogo), Azul (Elétrico), Verde (Ácido/Veneno), Preto (Ácido corrosivo), Branco (Gélido). Alcance: cone de 3 metros ou linha de 6 metros (varia pela linhagem). -3 de estamina por uso. Em nível 10: 2d6. Asas Cromáticas: De suas costas brotam asas membranosas, escuras como a noite, que lhe permitem voar como um predador. Deslocamento de voo de 9 metros. Enquanto voa, você não pode usar armas de duas mãos ou arcos longos. Suas asas permitem planar silenciosamente: +2 em testes de Furtividade durante o voo.",
"optionalTraits": [
...
"Escamas de Obsidiana: Suas escamas são negras e duras como vidro vulcânico, oferecendo proteção extra. +1 Defesa. Reduz 2 pontos de dano do mesmo tipo do seu Sopro Dracônico recebido.",
"Chamas da Ganância: Seu coração arde com o desejo de acumular tesouros, e essa chama o impulsiona. +2 Vontade. +2 em testes de Percepção para encontrar ou avaliar tesouros, gemas e itens valiosos."
]
},
{
"id": "raca-vampiro",
...
"optionalTraits": [
"Força das Montanhas: Seus músculos são fibras de aço forjadas nas altitudes. Você levanta pesos que fariam outros desabarem. +2 Força. Capacidade de carga é dobrada.",
...
"Fúria do Gigante: Quando ferido, sua fúria desperta e você se torna ainda mais perigoso. +1 Força. Sempre que sofrer dano, você pode entrar em fúria: +2 em testes de ataque corpo a corpo por 2 rodadas, mas -2 Defesa."
]
},
{
...
"fixedTrait": "Sangue Infernal: O fogo do submundo corre em suas veias. Você é resistente ao calor extremo e pode canalizar esse poder destrutivo. +2 Vontade. Resistência a dano de Calor: reduz em 2 pontos qualquer dano de fogo ou calor recebido. Labareda Infernal: Gastando 3 estamina, como Ação Principal, pode conjurar Labareda Infernal: cone de 3 metros que causa 1d6 + Vontade de dano de Calor (CD 15 de Destreza para reduzir à metade). Asas membranosas: brotam de suas costas, permitindo voos: pode planar ao cair de grandes alturas (não sofre dano de queda), pode voar por com deslocamento de 9 metros. Enquanto voa, você não pode usar armas de duas mãos ou arcos longos.",
"optionalTraits": [
...
"Chamas do Inferno: Seu sangue infernal queima em seus golpes. +1d4 de dano de Calor (fogo) em ataques corpo a corpo.",
"Pacto Sombrio: Você pode invocar uma fração do poder demoníaco por um preço. Como Ação de Suporte, gaste 3 pontos de Estamina para ganhar +2 Força e +1 Vontade por 2 turnos.",
"Manipulador Nato: Você herdou a lábia dos demônios, e suas palavras podem corromper os incautos. +2 em testes de Persuasão e Enganação. Uma vez por combate, ao manipular alguém, você pode forçar um alvo a um teste de Vontade (CD 16). Se falhar, ele age como você sugerir por 1 turno.",
"Olhar do Abismo: Seus olhos brilham como brasas na escuridão, e aqueles que os encaram sentem o peso do inferno. +1 Vontade. +2 em testes de Intimidação. Uma vez por combate, ao encarar um inimigo, você pode forçá-lo a um teste de Vontade (CD 15). Se falhar, ele sofre -2 em testes de ataque contra você por 2 rodadas."
]
},
{
...
"fixedTrait": "Sangue Celestial: A luz dos céus flui em suas veias. Você é um farol de esperança e possui dons curativos. +2 Vontade. Resistência a dano Gélido: efeitos de Congelamento: reduz em 2 pontos qualquer dano de frio recebido. Toque Curativo: Gastando 3 estamina, como Ação de Suporte, pode usar Toque Curativo: cura 1d6 + Vontade de PV em um aliado (ou em si mesmo). Asas emplumadas: brancas ou douradas, brotam de suas costas. pode planar ao cair de grandes alturas (não sofre dano de queda), pode voar com deslocamento de 9 metros. Enquanto voa, você não pode usar armas de duas mãos ou arcos longos.",
"optionalTraits": [
...
"Bênção da Aurora: Você carrega em si a luz do amanhecer, um poder que se renova a cada novo dia. +1 Vontade. No primeiro turno de cada combate, você recebe +1 em Iniciativa e +1 em testes de ataque. Uma vez por sessão, ao nascer do sol, você pode remover um efeito de status negativo de si mesmo (nível 2 ou inferior).",
"Visão da Verdade: Seus olhos foram tocados pela luz divina e conseguem enxergar através das mentiras. +1 Foco. +2 em testes de Intuição para detectar mentiras e intenções ocultas."
]
},
{
"id": "raca-crascker",
...
"Asas Camaleônicas: Suas asas mudam de cor para se camuflar no ambiente. +2 em testes de Furtividade. Você pode se esconder em ambientes naturais sem cobertura física, desde que permaneça imóvel."
]
},
{
"id": "raca-mechatron",
...
"Carapaça de Crustáceo: Sua pele é reforçada com placas naturais, como a carapaça de um caranguejo. +1 Defesa. Reduz 2 pontos de dano físico recebido (contundente, cortante, perfurante). Enquanto estiver submerso, a redução é de 4 pontos."
]
},
{
"id": "raca-platae",
...
"Seiva Vital: Sua seiva tem propriedades curativas excepcionais. Você pode gastar uma Ação de Suporte para liberar seiva sobre si mesmo ou um aliado adjacente, curando 1d4 + Constituição PV. Custo: 3 de Estamina por uso.",
...
"Memória das Raízes: Suas raízes podem sentir o solo e transmitir informações sobre o que aconteceu em uma área. +2 Intelecto. Uma vez por dia, ao tocar o solo, você pode \"perguntar\" às plantas o que aconteceu nas últimas 24 horas (movimento de criaturas, presença de magia, etc.).",
"Raízes Profundas: Suas raízes se estendem profundamente pelo solo, tornando-o quase impossível de derrubar. +1 Constituição. +2 em testes para resistir a empurrões, agarrões e desequilíbrios."
]
},
{
"id": "raca-undead",
...
"Poder Despertado: Sua alma aprisionada despertou um poder latente. Escolha um atributo. Você aumenta +2 permanente nesse atributo. Além disso, sempre que sua alma tentar assumir o controle (e você resistir), você ganha +2 em todos os testes por 3 rodadas em vez de 1.",
...
"Diálogo Interior: Você e sua alma aprisionada desenvolveram uma relação de comunicação constante, e ela o aconselha. +2 Intelecto. Uma vez por cena, ao realizar um teste de Intelecto ou Foco, você pode rolar novamente e ficar com o melhor resultado (a alma sussurra a resposta)."
]
},
{
...
"Arma Elemental: Você pode infundir automaticamente qualquer arma que empunhar com seu elemento. Ao segurar uma arma, ela é imediatamente envolvida pela sua energia elemental. A arma causa +1d4 de dano elemental e emite brilho ou efeito visual correspondente. Uma vez por combate, você pode sobrecarregar a infusão: a arma causa +2d4 de dano elemental por 1 turno, mas após isso a infusão automática é suprimida por 1 rodada. A infusão só funciona enquanto você empunhar a arma; se soltá-la, ela retorna ao normal ao fim do turno.",
