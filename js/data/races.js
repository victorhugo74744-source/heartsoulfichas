...
window.HEARTSOUL_RACES = [
 ...
 },
 {
  ...
  "optionalTraits": [
   ...
   "Força de Três Anões: Sua força é desproporcional ao seu tamanho, como se três anões vivessem em seu corpo. +1 Força. Sua capacidade de carga é calculada como se você tivesse +2 de Força adicional. Você pode carregar um aliado caído sem sofrer penalidades de movimento."
  ]
 },
 {
  "id": "raca-meio-an-o",
