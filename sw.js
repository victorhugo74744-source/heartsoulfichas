...
const CACHE_NAME = 'heartsoul-shell-v24'; // v24: livro de regras — seção "Mecânica de Sorte" (destaque "Quando usar" com os exemplos dentro, listas com marcador em vez de parágrafos soltos). regras.json, js/livro-de-regras.js e css/livro-de-regras.css mudaram, então sem este bump quem já visitou o site continuaria vendo a versão antiga a partir do cache.
