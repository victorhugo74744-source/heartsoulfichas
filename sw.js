...
const CACHE_NAME = 'heartsoul-shell-v23'; // v23: etapa de build (CSS/JS minificados, PNGs recomprimidos) + acabamento de design: identidade visual na tela de login (glow do selo, eyebrow, divisor), correção do spinner de carregamento das mesas (ficava desalinhado do texto por um conflito de grid) e do estado de erro do livro de regras (sem estilo nenhum antes), e contraste de --ink-mute elevado pra AAA em todo o site. css/*.css e index.html mudaram, então sem este bump quem já visitou o site continuaria vendo a versão antiga a partir do cache.
