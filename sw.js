...
const CACHE_NAME = 'heartsoul-shell-v28'; // v28: livro de regras — capítulo "Lore do Mundo" mostrava a introdução do Panteão duas vezes (renderChapter e renderLoreChapter desenhavam o mesmo chapter.intro); js/livro-de-regras.js mudou, então sem este bump o cache antigo continuaria sendo servido.
