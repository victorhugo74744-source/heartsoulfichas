...
const CACHE_NAME = 'heartsoul-shell-v20'; // v20: correção do painel "Complementos" do Mestre (master.html/js/master.js) — initComplementosPanel nunca era chamado, então a seção ficava vazia; não apareceria pra quem já visitou o site sem este bump, pelo mesmo motivo das vezes anteriores.
