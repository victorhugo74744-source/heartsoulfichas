...
const CACHE_NAME = 'heartsoul-shell-v25'; // v25: livro de regras — capítulo "Criação de Itens e Ofícios" reestruturado (subtítulos, listas com marcador, destaque no exemplo) e frases de abertura que viravam cartão com a frase inteira como título (Combate, Catálogo de Traços, Treinamento). regras.json e js/livro-de-regras.js mudaram, então sem este bump o cache antigo continuaria sendo servido.
