...
const CACHE_NAME = 'heartsoul-shell-v27'; // v27: traços "Força Desproporcional" (meio-orc) e "Força de Três Anões" (anão) passam a dar +2 de Constituição só para a capacidade de carga (texto trocado de Força para Constituição em js/data/races.js e regras.json) e o cálculo de peso do editor, da ficha e da mesa (js/editor-core.js, js/editor-misc.js, js/view.js, js/mesa-tokens.js) soma esse bônus — sem este bump o cache antigo continuaria sendo servido.
